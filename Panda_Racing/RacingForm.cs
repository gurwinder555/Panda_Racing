...
namespace Panda_Racing
{
    public partial class RacingForm : Form
    {
        ...
        private void SetupRaceTrack()
        {
            ...
            punters[2] = pFactory.getPunter("Gurwinder", MaximumBet, GurwinderBet); //getting Gurwinder object from factory class
        ...
        private void GurwinderButton_CheckedChanged(object sender, EventArgs e)
        {
